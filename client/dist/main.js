...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__field_googlemapsfield__ = __webpack_require__(12);


var init = function init() {
  Object(__WEBPACK_IMPORTED_MODULE_0__field_googlemapsfield__["a" /* default */])();
};
...
var targets = document.body.querySelectorAll('input[data-mapsfield=mapsfield]');
var latField = document.getElementById('GoogleMapsLatField');
var lngField = document.getElementById('GoogleMapsLngField');
...
var fillAddress = function fillAddress() {
  ...
  components.forEach(function (component) {
    var field = document.getElementById(component.types[0]);
    field.setAttribute('value', component.long_name);
  });
};

var mountMapsField = function mountMapsField(mapsfield) {
  options = __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_assign___default()(options, window.customisations);
